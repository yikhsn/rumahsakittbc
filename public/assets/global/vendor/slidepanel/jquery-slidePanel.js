...
(function(global, factory) {
                    ...
                    if (options.mouseDrag) {
                        ...
                        $panel.on(SlidePanel.eventName('dragstart selectstart'), function(
                            ...
                            if (options.mouseDragHandler) {
                                if (!(0, _jquery2.default)(event.target).is(
            ...
            },
            {
                ...
                value: function getHidePosition() {
                    ...
                    switch (options.direction) {
                        case 'top':
                        case 'bottom':
                            return parseFloat(-(this._length / (0, _jquery2.default)(window).height()) * 100,
                                10
                            );
                        case 'left':
                        case 'right':
                            return parseFloat(-(this._length / (0, _jquery2.default)(window).width()) * 100,
                                10
                            );
                            // no default
                    }
    ...
    var api = {
        ...
        hide: function hide() {
            for (
                var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++
            ) {
