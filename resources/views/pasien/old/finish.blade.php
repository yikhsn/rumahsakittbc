          ...
          <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="col-md-11">
                    ...
                    <hr style="background-color:#585858;">
                    <center>
                    <h6>Identitas Pasien dan Hasil Pemeriksaan Pasien</h6>
                    </center>
                    <hr style="background-color:#585858;">
                    <div class="row">
                        <div class="col-md-2">
                ...
                <hr style="background-color:#585858 ;">
                <center>
                <h6>Riwayat Penyakit TBC Sebelumnya</h6>
                </center>
                <hr style="background-color:#585858 ;">
                <div class="row">
                  <div class="col-md-2">
                    ...
                    <p>Awal Pengobatan</p>
                    <br>
                    <p>Akhir Pengobatan</p>
                    <br>
                    <p>Kelengkapan Pengobatan</p>
                    <br>
                    <p>Rumah Sakit</p>
                    <br>
                    <p>Dokter</p>
                  ...
                  <div class="col-md-4">
                    <!-- NIK -->
                    <input type="text" class="form-control" style="border-top:0px; border-left:0px; border-right:0px; border-bottom-color: #808080; background-color:white;" disabled name="awal_pengobatan_sebelumnya" value="{{ $pasien->awal_pengobatan_sebelumnya }}">
                    <br>
                    <!-- Nama Lengkap -->
                    <input type="text" class="form-control" style="border-top:0px; border-left:0px; border-right:0px; border-bottom-color: #808080; background-color:white;" disabled name="akhir_pengobatan_sebelumnya" value="{{ $pasien->akhir_pengobatan_sebelumnya }}">
                    <br>
                    <br>

                    <!-- Tempat Tanggal Lahir -->
                    <input type="text" class="form-control" style="border-top:0px; border-left:0px; border-right:0px; border-bottom-color: #808080; background-color:white;" disabled name="kelangkapan_pengobatan_sebelumnya" value="{{ $pasien->kelangkapan_pengobatan_sebelumnya }}">
                    <br>
                    <!-- Jenis Kelamin -->
                    <input type="text" class="form-control" style="border-top:0px; border-left:0px; border-right:0px; border-bottom-color: #808080; background-color:white;" disabled name="tempat_pengobatan_sebelumnya" value="{{ $pasien->tempat_pengobatan_sebelumnya }}">
                    <br>
                    <!-- Nomor Telepon -->
                    <input type="text" class="form-control" style="border-top:0px; border-left:0px; border-right:0px; border-bottom-color: #808080; background-color:white;" disabled name="nama_dokter_sebelumnya" value="{{ $pasien->nama_dokter_sebelumnya }}">
                    <br>
                  ...
                  <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" style="border-top:0px; border-left:0px; border-right:0px; border-bottom-color: #808080; background-color:white;" disabled name="jumlah_sputum_sebelumnya" value="{{ $pasien->jumlah_sputum_sebelumnya }}">
                    <br>
                    <!-- Informasi Lainnya -->
                    <input type="text" class="form-control" style="border-top:0px; border-left:0px; border-right:0px; border-bottom-color: #808080; background-color:white;" disabled name="hasil_sputum_sebelumnya" value="{{ $pasien->hasil_sputum_sebelumnya }}">
                  </div>
                </div>
                <br>
